...
import kotlinx.android.synthetic.main.activity_sports_quiz_questions.*

class SportsQuizQuestionsActivity : AppCompatActivity(), View.OnClickListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        title = "  Sports"
        setContentView(R.layout.activity_sports_quiz_questions)

        mUserName = intent.getStringExtra(Constants.USER_NAME)
        mQuestionList = Constants.getSportsQuestions()
