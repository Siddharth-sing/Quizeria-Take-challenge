...
import kotlinx.android.synthetic.main.activity_green_earth_quiz_questions.*

class GreenEarthQuizQuestionsActivity : AppCompatActivity(), View.OnClickListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        title = "  Green Earth"
        setContentView(R.layout.activity_green_earth_quiz_questions)

        mUserName = intent.getStringExtra(Constants.USER_NAME)
        mQuestionList = Constants.getGreenEarthQuestions()
