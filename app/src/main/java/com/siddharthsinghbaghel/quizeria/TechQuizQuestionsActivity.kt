...
import kotlinx.android.synthetic.main.activity_tech_quiz_questions.*


class TechQuizQuestionsActivity : AppCompatActivity(), View.OnClickListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        title = "  Tech"
        setContentView(R.layout.activity_tech_quiz_questions)

        mUserName = intent.getStringExtra(Constants.USER_NAME)
        mQuestionList = Constants.getTechQuestions()
