...
import kotlinx.android.synthetic.main.activity_covid_quiz_questions.*

class CovidQuizQuestionsActivity : AppCompatActivity(), View.OnClickListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        title = "  Covid Awareness Quiz"
        setContentView(R.layout.activity_covid_quiz_questions)

        mUserName = intent.getStringExtra(Constants.USER_NAME)
        mQuestionList = Constants.getCovidQuestions()
                ...
                if(mSelectedOptionPosition == 0) {
                    ...
                    when {
                        progressBarNumber <= 10 -> {
                            ...
                            intent.putExtra(Constants.TOTAL_QUESTION, 10)
