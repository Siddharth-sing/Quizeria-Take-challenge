...
import kotlinx.android.synthetic.main.activity_india_quiz_questions.*
import kotlin.random.Random

class IndiaQuizQuestionsActivity : AppCompatActivity(), View.OnClickListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        title = "  Great India"
        setContentView(R.layout.activity_india_quiz_questions)

        mUserName = intent.getStringExtra(Constants.USER_NAME)
        mQuestionList = Constants.getIndiaQuestions()
